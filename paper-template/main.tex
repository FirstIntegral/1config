...
% --- no bibliography by design ------------------------------------------
% The paper is AI-written and self-contained: no bibliography, no \cite, no
% reference list. Prior art is described in prose, never cited.
...
\TODO{self-contained context in prose — no citations, no reference list; derive or assume, never defer to a reference}
